		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "displa",
									"targetURL": "#comexampledisplay-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampledisplay-display": {
								"semanticObject": "comexampledisplay",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.display",
									"url": sap.ui.require.toUrl("com/example/display")
								}
							}
						}
					}
